...
public class CommonsHttpOAuthConsumer extends AbstractOAuthConsumer
{
    ...
    protected oauth.signpost.http.HttpRequest wrap(Object obj)
    {
        ...
        {
            throw new IllegalArgumentException((new StringBuilder("This consumer expects requests of type ")).append(org/apache/http/HttpRequest.getCanonicalName()).toString());
        } else
        {
