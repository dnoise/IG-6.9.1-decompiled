...
public final class  extends StdScalarSerializer
{
    ...
    {
        serialize((AtomicLong)obj, h1, serializerprovider);
    }

    public final void serialize(AtomicLong atomiclong, h h1, SerializerProvider serializerprovider)
    {
        h1.writeNumber(atomiclong.get());
    }
