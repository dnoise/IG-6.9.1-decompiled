    ...
    implements VisibilityChecker, Serializable
{
    ...
    public with withCreatorVisibility(com.fasterxml.jackson.annotation.ity ity)
    {
        ...
        {
            com.fasterxml.jackson.annotation.ity ity1 = _getterMinLevel;
            com.fasterxml.jackson.annotation.ity ity2 = _isGetterMinLevel;
            com.fasterxml.jackson.annotation.ity ity3 = _setterMinLevel;
            com.fasterxml.jackson.annotation.ity ity4 = _fieldMinLevel;
    ...
    public withFieldVisibility withGetterVisibility(com.fasterxml.jackson.annotation.ity ity)
    {
        ...
        {
            com.fasterxml.jackson.annotation.ity ity1 = _isGetterMinLevel;
            com.fasterxml.jackson.annotation.ity ity2 = _setterMinLevel;
            com.fasterxml.jackson.annotation.ity ity3 = _creatorMinLevel;
            com.fasterxml.jackson.annotation.ity ity4 = _fieldMinLevel;
