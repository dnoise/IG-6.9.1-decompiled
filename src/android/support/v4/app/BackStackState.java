    ...
    implements Parcelable
{
    ...
    public final b a(u u1)
    {
        ...
        for (int k = 0; k < a.length; k = k2)
        {
            ...
            if (u.a)
            {
                (new StringBuilder("Instantiate ")).append(b1).append(" op #").append(j).append(" base fragment #").append(a[l]);
            }
            int ai1[] = a;
            int i1 = l + 1;
            int j1 = ai1[l];
            ...
            if (l2 > 0)
            {
                ...
                for (int i3 = 0; i3 < l2;)
                {
                    if (u.a)
                    {
                        (new StringBuilder("Instantiate ")).append(b1).append(" set remove fragment #").append(a[k2]);
                    }
                    ArrayList arraylist = u1.f;
                    int ai7[] = a;
                    int j3 = k2 + 1;
