...
public final class AuthSchemeRegistry
{
    ...
    public final AuthScheme getAuthScheme(String s, HttpParams httpparams)
    {
        if (s == null)
        {
        ...
        {
            throw new IllegalStateException((new StringBuilder("Unsupported authentication scheme: ")).append(s).toString());
        }
    }
    ...
    public final void register(String s, AuthSchemeFactory authschemefactory)
    {
        if (s == null)
        {
            throw new IllegalArgumentException("Name may not be null");
