...
class AsynchronousValidator
{
    ...
    public void revalidateCacheEntry(HttpHost httphost, HttpRequest httprequest, HttpContext httpcontext, HttpCacheEntry httpcacheentry)
    {
        ...
        asynchronousvalidationrequest = new AsynchronousValidationRequest(this, cachingClient, httphost, httprequest, httpcontext, httpcacheentry, s);
...
_L2:
        ...
        log.debug((new StringBuilder("Revalidation for [")).append(s).append("] not scheduled: ").append(rejectedexecutionexception).toString());
