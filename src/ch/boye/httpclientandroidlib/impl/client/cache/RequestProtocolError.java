...
final class RequestProtocolError extends Enum
{
    ...
    static 
    {
        ...
        RequestProtocolError arequestprotocolerror[] = new RequestProtocolError[5];
        arequestprotocolerror[0] = UNKNOWN;
        arequestprotocolerror[1] = BODY_BUT_NO_LENGTH_ERROR;
        arequestprotocolerror[2] = WEAK_ETAG_ON_PUTDELETE_METHOD_ERROR;
        arequestprotocolerror[3] = WEAK_ETAG_AND_RANGE_ERROR;
        arequestprotocolerror[4] = NO_CACHE_DIRECTIVE_WITH_FIELD_NAME;
        $VALUES = arequestprotocolerror;
    }
}
