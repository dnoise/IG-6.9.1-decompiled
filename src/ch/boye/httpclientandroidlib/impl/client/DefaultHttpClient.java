...
public class DefaultHttpClient extends AbstractHttpClient
{
    ...
    public static void setDefaultHttpParams(HttpParams httpparams)
    {
        ...
        VersionInfo versioninfo = VersionInfo.loadVersionInfo("ch.boye.httpclientandroidlib.client", ch/boye/httpclientandroidlib/impl/client/DefaultHttpClient.getClassLoader());
        String s;
        if (versioninfo != null)
        {
        ...
        HttpProtocolParams.setUserAgent(httpparams, (new StringBuilder("Apache-HttpClient/")).append(s).append(" (java 1.5)").toString());
    }
