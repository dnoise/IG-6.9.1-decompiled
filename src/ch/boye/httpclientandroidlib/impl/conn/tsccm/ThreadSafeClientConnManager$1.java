...
//            PoolEntryRequest, ThreadSafeClientConnManager, BasicPooledConnAdapter
    ...
    implements ClientConnectionRequest
{
    ...
    public ManagedClientConnection getConnection(long l, TimeUnit timeunit)
    {
        ...
        {
            log.debug((new StringBuilder("Get connection: ")).append(val$route).append(", timeout = ").append(l).toString());
        }
        BasicPoolEntry basicpoolentry = val$poolRequest.getPoolEntry(l, timeunit);
