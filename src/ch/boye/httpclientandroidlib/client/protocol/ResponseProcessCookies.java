...
_L1:
        ...
        {
            log.debug((new StringBuilder("Cookie accepted: \"")).append(cookie).append("\". ").toString());
        }
          goto _L1
...
_L2:
        log.warn((new StringBuilder("Cookie rejected: \"")).append(cookie).append("\". ").append(malformedcookieexception1.getMessage()).toString());
          goto _L1
        MalformedCookieException malformedcookieexception;
        malformedcookieexception;
        if (log.isWarnEnabled())
        {
            log.warn((new StringBuilder("Invalid cookie header: \"")).append(header).append("\". ").append(malformedcookieexception.getMessage()).toString());
        }
