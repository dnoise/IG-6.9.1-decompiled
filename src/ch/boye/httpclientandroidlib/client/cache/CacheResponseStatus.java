...
public final class CacheResponseStatus extends Enum
{
    ...
    static 
    {
        ...
        CacheResponseStatus acacheresponsestatus[] = new CacheResponseStatus[4];
        acacheresponsestatus[0] = CACHE_MODULE_RESPONSE;
        acacheresponsestatus[1] = CACHE_HIT;
        acacheresponsestatus[2] = CACHE_MISS;
        acacheresponsestatus[3] = VALIDATED;
        $VALUES = acacheresponsestatus;
    }
}
